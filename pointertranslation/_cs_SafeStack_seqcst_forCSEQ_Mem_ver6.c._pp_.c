/*  Generated 0.0.0.0.0.0 (-t3 -r4 -u3 -bcbmc) 2015-12-02 17:15:13  */
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
typedef 
                                                       ...
                                                       SafeStack stack;
                                                       int MEMORY_VALUE[6];
                                                       unsigned int __CS_atomic_malloc(unsigned int __csLOCALPARAM___CS_atomic_malloc_size)
                                                       {
                                                         return 0;
                                                       }
                                                       ...
                                                       {
                                                         MEMORY_VALUE[__csLOCALPARAM___CS_atomic_store_ADDR_obj] = __csLOCALPARAM___CS_atomic_store_ADDR_v;
                                                       }
                                                       ...
                                                       {
                                                         return MEMORY_VALUE[__csLOCALPARAM___CS_atomic_load_ADDR_obj];
                                                       }
                                                       ...
                                                       int __CS_atomic_exchange_ADDR(unsigned int __csLOCALPARAM___CS_atomic_exchange_ADDR_obj, int __csLOCALPARAM___CS_atomic_exchange_ADDR_v)
                                                       {
                                                         ...
                                                         __csLOCAL___CS_atomic_exchange_ADDR_t = MEMORY_VALUE[__csLOCALPARAM___CS_atomic_exchange_ADDR_obj];
                                                         MEMORY_VALUE[__csLOCALPARAM___CS_atomic_exchange_ADDR_obj] = __csLOCALPARAM___CS_atomic_exchange_ADDR_v;
...
tthread_0_57: IF(1,57,tthread_0_58)                    __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_0_58: IF(1,58,tthread_0_59)                    MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_0_59: IF(1,59,tthread_0_60)                    assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
...
tthread_0_126: IF(1,126,tthread_0_127)                 __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_0_127: IF(1,127,tthread_0_128)                 MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_0_128: IF(1,128,tthread_0_129)                 assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
                                                       static int __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static int __csLOCAL_Push_head1;
...
tthread_1_57: IF(2,57,tthread_1_58)                    __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_1_58: IF(2,58,tthread_1_59)                    MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_1_59: IF(2,59,tthread_1_60)                    assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
                                                       static int __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static int __csLOCAL_Push_head1;
...
tthread_1_126: IF(2,126,tthread_1_127)                 __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_1_127: IF(2,127,tthread_1_128)                 MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_1_128: IF(2,128,tthread_1_129)                 assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
                                                       static int __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static int __csLOCAL_Push_head1;
...
tthread_2_57: IF(3,57,tthread_2_58)                    __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_2_58: IF(3,58,tthread_2_59)                    MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_2_59: IF(3,59,tthread_2_60)                    assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
                                                       static int __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static int __csLOCAL_Push_head1;
...
tthread_2_126: IF(3,126,tthread_2_127)                 __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       ;
tthread_2_127: IF(3,127,tthread_2_128)                 MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] = __csLOCAL_thread_idx;
tthread_2_128: IF(3,128,tthread_2_129)                 assert(MEMORY_VALUE[(stack.array + (2 * __csLOCAL_thread_elem)) + 0] == __csLOCAL_thread_idx);
                                                       		{
                                                       static int __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static int __csLOCAL_Push_head1;
