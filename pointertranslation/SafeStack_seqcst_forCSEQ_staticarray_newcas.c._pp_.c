...
# 1 "<command-line>" 2
# 1 "<stdin>"
# 1 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
...
# 2 "./preprocessor/ccpp-0.1/fake_include/stdio.h" 2
# 2 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/stdlib.h" 1
# 3 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/pthread.h" 1
# 4 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/unistd.h" 1
# 5 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/assert.h" 1
# 6 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_staticarray_newcas.c" 2
...
_Bool __VERIFIER_atomic_compare_and_swap(int *obj, int expected, int desired)
{
    if(*obj == expected)
    {
        *obj = desired;
...
int Pop(void)
{
    while (__VERIFIER_atomic_load(&stack.count) > 1)
    {
        ...
        {
            int head2 = head1;
            if (__VERIFIER_atomic_compare_and_swap(&stack.head, head2, next1))
            {
...
void Push(int index)
{
    ...
    } while (!(__VERIFIER_atomic_compare_and_swap(&stack.head, head1, index)));
