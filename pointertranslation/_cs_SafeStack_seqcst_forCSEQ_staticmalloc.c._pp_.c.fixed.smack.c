...
unsigned int active_thread[THREADS+1]={1};
...
int __cs_sched_yield(unsigned int val) {pc_cs = val + 1; return 0;}    // Version 1
//int __cs_sched_yield(unsigned int val) {return 0;}     // Version 2
...
unsigned int guess_pc() {return __VERIFIER_nondet_uint();}
