/*  Generated 0.0.0.0.0.0 (-t3 -r4 -u3 -bcbmc) 2015-12-02 14:41:50  */
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
// 270828 variables, 1046461 clauses  (real 3m41.567s user  3m41.019s sys 0m0.090s )   with 4bits for all (data and addresses)
// 1282697 variables, 4863356 clauses
                                                       ...
                                                       int __CS_atomic_READ(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_READ_address)
                                                       {
                                                         return TRACK_VALUE[__csLOCALPARAM___CS_atomic_READ_address - 1];
                                                       }

                                                       void __CS_atomic_WRITE(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_WRITE_address, int __csLOCALPARAM___CS_atomic_WRITE_value)
                                                       {
...
typedef
                                                       ...
                                                       void __CS_atomic_store_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_store_ADDR_obj, int __csLOCALPARAM___CS_atomic_store_ADDR_v)
                                                       {
                                                       ...
                                                       int __CS_atomic_load_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_load_ADDR_obj)
                                                       {
                                                       ...
                                                       int __CS_atomic_exchange_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_exchange_ADDR_obj, int __csLOCALPARAM___CS_atomic_exchange_ADDR_v)
                                                       {
                                                         static unsigned __CPROVER_bitvector[4] __csLOCAL___CS_atomic_exchange_ADDR_pos;
                                                         __csLOCAL___CS_atomic_exchange_ADDR_pos = nondet_uint();
                                                         __CPROVER_assume(__csLOCAL___CS_atomic_exchange_ADDR_pos < 6);
                                                         __CPROVER_assume(TRACK_ADDRESS[__csLOCAL___CS_atomic_exchange_ADDR_pos] == __csLOCALPARAM___CS_atomic_exchange_ADDR_obj);
                                                         static int __csLOCAL___CS_atomic_exchange_ADDR_t;
                                                         __csLOCAL___CS_atomic_exchange_ADDR_t = TRACK_VALUE[__csLOCAL___CS_atomic_exchange_ADDR_pos];
                                                         TRACK_VALUE[__csLOCAL___CS_atomic_exchange_ADDR_pos] = __csLOCALPARAM___CS_atomic_exchange_ADDR_v;
