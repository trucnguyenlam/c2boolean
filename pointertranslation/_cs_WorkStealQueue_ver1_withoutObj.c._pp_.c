/*  Generated 0.0.0.0.0.0 (-t1 -r2 -u4 -bcbmc) 2015-12-09 23:42:50  */
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
typedef 
                                                       ...
                                                       long __CS_atomic_exchange(long *__csLOCALPARAM___CS_atomic_exchange_obj, long __csLOCALPARAM___CS_atomic_exchange_desired)
                                                       {
                                                         static long __csLOCAL___CS_atomic_exchange_t;
                                                         __csLOCAL___CS_atomic_exchange_t = *__csLOCALPARAM___CS_atomic_exchange_obj;
                                                         *__csLOCALPARAM___CS_atomic_exchange_obj = __csLOCALPARAM___CS_atomic_exchange_desired;
...
IF(1,0,tStealer_0_1)                                   __csLOCAL_Stealer_q = (WorkStealQueue *) __csLOCALPARAM_Stealer_param;
                                                       ...
                                                       __cs_init_scalar(&__csLOCAL_Stealer_r, sizeof(int *));
...
tStealer_0_15: IF(1,15,tStealer_0_16)                  *__csLOCALPARAM_Operation_r += 1;
...
tStealer_0_30: IF(1,30,tStealer_0_31)                  *__csLOCALPARAM_Operation_r += 1;
...
IF(0,0,tmain_1)                                        static int __csLOCAL_main_i;
                                                       ...
                                                       *__csLOCALPARAM_Init_ObjType_r = 0;
                                                       ...
                                                       0;
                                                       (*__csLOCALPARAM_Init_WorkStealQueue_q).elems = __cs_safe_malloc(__csLOCALPARAM_Init_WorkStealQueue_size * (sizeof(int *)));
...
tmain_26: IF(0,26,tmain_27)                            __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
...
tmain_69: IF(0,69,tmain_70)                            assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_70: IF(0,70,tmain_71)                            __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_88: IF(0,88,tmain_89)                            __cs_mutex_unlock_MACRO((*__csLOCALPARAM_SyncPush_q).cs);
                                                       ...
                                                       __cs_init_scalar(&__csLOCAL_main_r, sizeof(int *));
...
tmain_120: IF(0,120,tmain_121)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_145: IF(0,145,tmain_146)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_146: IF(0,146,tmain_147)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_189: IF(0,189,tmain_190)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_190: IF(0,190,tmain_191)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_240: IF(0,240,tmain_241)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_265: IF(0,265,tmain_266)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_266: IF(0,266,tmain_267)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_309: IF(0,309,tmain_310)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_310: IF(0,310,tmain_311)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_360: IF(0,360,tmain_361)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_385: IF(0,385,tmain_386)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_386: IF(0,386,tmain_387)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_429: IF(0,429,tmain_430)                         assert(__csLOCAL_SyncPush_newsize < (*__csLOCALPARAM_SyncPush_q).MaxSize);
                                                       static int **__csLOCAL_SyncPush_newtasks;
tmain_430: IF(0,430,tmain_431)                         __csLOCAL_SyncPush_newtasks = __cs_safe_malloc(__csLOCAL_SyncPush_newsize * (sizeof(int *)));
                                                       static long __csLOCAL_SyncPush_i;
                                                       __csLOCAL_SyncPush_i = 0;
                                                       if (!(__csLOCAL_SyncPush_i < __csLOCAL_SyncPush_count))
                                                       						{
...
tmain_480: IF(0,480,tmain_481)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_512: IF(0,512,tmain_513)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_544: IF(0,544,tmain_545)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_576: IF(0,576,tmain_577)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_608: IF(0,608,tmain_609)                         *__csLOCALPARAM_Operation_r += 1;
...
tmain_611: IF(0,611,tmain_612)                         assert((*__csLOCALPARAM_Check_r) == 1);
...
tmain_613: IF(0,613,tmain_614)                         assert((*__csLOCALPARAM_Check_r) == 1);
...
tmain_615: IF(0,615,tmain_616)                         assert((*__csLOCALPARAM_Check_r) == 1);
...
tmain_617: IF(0,617,tmain_618)                         assert((*__csLOCALPARAM_Check_r) == 1);
