/*  Generated {"main": [[1, 6]], "thread_1": [[1, 34], [35, 68]], "thread_0": [[1, 34], [35, 68]], "thread_2": [[35, 68], [69, 102]]} (-t3 -r4 -u3 -bcbmc) 2015-12-10 14:33:21  */
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
/* here */
                                                       ...
                                                       __cs_t threads[3];
                                                       __CPROVER_bitvector[4] MEMORY_VALUE[8];
                                                       #define array_Value 0
                                                       #define array_Next 3
                                                       #define head 6
                                                       #define count 7
                                                       ...
                                                       _Bool __CS_atomic_compare_and_exchange(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_compare_and_exchange_obj, __CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_compare_and_exchange_expected, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_compare_and_exchange_desired)
                                                       {
...
tthread_0_68: IF(1,68,tthread_0_69)                    __csLOCAL_Push___while_cond_1 = !__CS_atomic_compare_and_exchange(head, &__csLOCAL_Push_head1, __csLOCALPARAM_Push_index);
                                                       ...
                                                       ;
                                                       MEMORY_VALUE[array_Value + __csLOCAL_thread_elem] = __csLOCAL_thread_idx;
                                                       assert(MEMORY_VALUE[array_Value + __csLOCAL_thread_elem] == __csLOCAL_thread_idx);
                                                       		{
                                                       static __CPROVER_bitvector[4] __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static __CPROVER_bitvector[4] __csLOCAL_Push_head1;
...
tthread_2_23: IF(3,23,tthread_2_24)                    __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(count) > 1;
                                                       ...
                                                       ;
tthread_2_24: IF(3,24,tthread_2_25)                    MEMORY_VALUE[array_Value + __csLOCAL_thread_elem] = __csLOCAL_thread_idx;
tthread_2_25: IF(3,25,tthread_2_26)                    assert(MEMORY_VALUE[array_Value + __csLOCAL_thread_elem] == __csLOCAL_thread_idx);
                                                       		{
                                                       static __CPROVER_bitvector[4] __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static __CPROVER_bitvector[4] __csLOCAL_Push_head1;
...
tmain_6:                                               STOP_NONVOID(6);
                                                       ...
                                                       __CPROVER_bitvector[4] main(void) {
                                                                 // round 0
                                                                 thread_index = 0;
                                                                 pc_cs = pc[0] + guess_pc();
