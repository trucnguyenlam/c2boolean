...
__CPROVER_bitvector[4] nondet_int();
...
/* pthread API */
typedef __CPROVER_bitvector[4] __cs_t;
typedef __CPROVER_bitvector[4] __cs_attr_t;
typedef __CPROVER_bitvector[4] __cs_mutex_t;
typedef __CPROVER_bitvector[4] __cs_mutexattr_t;
typedef __CPROVER_bitvector[4] __cs_cond_t;
typedef __CPROVER_bitvector[4] __cs_condattr_t;
typedef __CPROVER_bitvector[4] __cs_spinlock_t;
typedef __CPROVER_bitvector[4] __cs_key_t;
typedef __CPROVER_bitvector[4] __cs_once_t;
typedef __CPROVER_bitvector[4] __cs_rwlock_t;
typedef __CPROVER_bitvector[4] __cs_rwlockattr_t;
typedef __CPROVER_bitvector[4] __cs_barrier_t;
typedef __CPROVER_bitvector[4] __cs_barrierattr_t;
...
__CPROVER_bitvector[4] __cs_create(__cs_t *id, void *attr, void *(*t)(void*), void *arg, __CPROVER_bitvector[4] threadID) { if (threadID > THREADS) return 0;  *id = threadID; active_thread[threadID] = 1; threadargs[threadID] = arg; return 0; }
__CPROVER_bitvector[4] __cs_join(__cs_t id, void **value_ptr) { assume(pc[id] == thread_lines[id]); return 0; }

void __cs_exit(void *value_ptr) { return; }   // only for parsing
__cs_t __cs_self() {  return thread_index;  }
__CPROVER_bitvector[4] __cs_cancel(__cs_t id) {  return 0;  }

__CPROVER_bitvector[4] __cs_mutex_init (__cs_mutex_t *m, __CPROVER_bitvector[4] val) { *m = -1; return 0; }
__CPROVER_bitvector[4] __cs_mutex_destroy(__cs_mutex_t *m) { return 0; }
__CPROVER_bitvector[4] __cs_mutex_lock(__cs_mutex_t *m) { assume(*m == -1); *m = thread_index; return 0; }
__CPROVER_bitvector[4] __cs_mutex_unlock(__cs_mutex_t *m) { assume(*m == thread_index); *m = -1; return 0; }

__CPROVER_bitvector[4] __cs_cond_init(__cs_cond_t *cond, void *attr) { *cond = -1; return 0; }
__CPROVER_bitvector[4] __cs_cond_destroy(__cs_cond_t *cond) { return 0; }
/* Already handle in lock optimizer module */
// __CPROVER_bitvector[4] __cs_cond_wait(__cs_cond_t *cond, __cs_mutex_t *mutex) { __cs_mutex_unlock(mutex); assume(*cond != -1); __cs_mutex_lock(mutex); return 0;}
// __CPROVER_bitvector[4] __cs_cond_timedwait(__cs_cond_t *cond, __cs_mutex_t *mutex, struct timespec *abstime) { if(__VERIFIER_nondet_bool()) {__cs_mutex_unlock(mutex); assume(*cond != -1); __cs_mutex_lock(mutex); return 0;} else {return ETIMEDOUT;}}
__CPROVER_bitvector[4] __cs_cond_signal(__cs_cond_t *cond) { *cond = 1; return 0; }
__CPROVER_bitvector[4] __cs_cond_broadcast(__cs_cond_t *cond) { *cond = 2; return 0; }

__CPROVER_bitvector[4] __cs_spin_init(__cs_spinlock_t *l, __CPROVER_bitvector[4] val) {*l = -1; return 0;}
__CPROVER_bitvector[4] __cs_spin_destroy(__cs_spinlock_t *l) {return 0;}
__CPROVER_bitvector[4] __cs_spin_lock(__cs_spinlock_t *l) { assume(*l == -1); *l = thread_index; return 0; }
__CPROVER_bitvector[4] __cs_spin_unlock(__cs_spinlock_t *l) { assume(*l == thread_index); *l = -1; return 0; }
...
__CPROVER_bitvector[4] __cs_sched_yield(unsigned __CPROVER_bitvector[9] val) {pc_cs = val + 1; return 0;}    // Version 1
//__CPROVER_bitvector[4] __cs_sched_yield(unsigned __CPROVER_bitvector[9] val) {return 0;}     // Version 2
...
void __cs_init_scalar(void *var, size_t size) {
    if (size == sizeof(__CPROVER_bitvector[4]))
        *(__CPROVER_bitvector[4] *)var = __VERIFIER_nondet_int();
    else {
        char * ptr = (char *)var;
        // size_t j;
        // for (j=0; j<size; j++)
...
/* here */
                                                       ...
                                                       unsigned __CPROVER_bitvector[4] TRACK_ADDRESS[6];
                                                       __CPROVER_bitvector[4] TRACK_VALUE[6];
                                                       unsigned __CPROVER_bitvector[4] num_malloc;
                                                       extern unsigned __CPROVER_bitvector[4] nondet_uint(void);
                                                       ...
                                                       unsigned __CPROVER_bitvector[4] __CS_atomic_malloc(size_t __csLOCALPARAM___CS_atomic_malloc_size)
                                                       {
                                                         static unsigned __CPROVER_bitvector[4] __csLOCAL___CS_atomic_malloc_tmp;
                                                       ...
                                                       void __CS_atomic_free(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_free_address)
                                                       {
                                                       }

                                                       __CPROVER_bitvector[4] __CS_atomic_READ(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_READ_address)
                                                       {
                                                         return TRACK_VALUE[__csLOCALPARAM___CS_atomic_READ_address - 1];
                                                       }

                                                       void __CS_atomic_WRITE(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_WRITE_address, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_WRITE_value)
                                                       {
...
typedef
                                                       struct SafeStack
                                                       {
                                                       		unsigned __CPROVER_bitvector[4] array;
                                                       		__CPROVER_bitvector[4] head;
                                                       		__CPROVER_bitvector[4] count;
                                                       } SafeStack;
                                                       __cs_t threads[3];
                                                       SafeStack stack;
                                                       void __CS_atomic_store(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_store_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_store_v)
                                                       {
                                                         *__csLOCALPARAM___CS_atomic_store_obj = __csLOCALPARAM___CS_atomic_store_v;
                                                       }

                                                       void __CS_atomic_store_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_store_ADDR_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_store_ADDR_v)
                                                       {
                                                         __CS_atomic_WRITE(__csLOCALPARAM___CS_atomic_store_ADDR_obj, __csLOCALPARAM___CS_atomic_store_ADDR_v);
                                                       }

                                                       __CPROVER_bitvector[4] __CS_atomic_load(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_load_obj)
                                                       {
                                                         return *__csLOCALPARAM___CS_atomic_load_obj;
                                                       }

                                                       __CPROVER_bitvector[4] __CS_atomic_load_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_load_ADDR_obj)
                                                       {
                                                         return __CS_atomic_READ(__csLOCALPARAM___CS_atomic_load_ADDR_obj);
                                                       }

                                                       __CPROVER_bitvector[4] __CS_atomic_exchange(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_exchange_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_exchange_v)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[4] __CS_atomic_exchange_ADDR(unsigned __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_exchange_ADDR_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_exchange_ADDR_v)
                                                       {
                                                         static __CPROVER_bitvector[4] __csLOCAL___CS_atomic_exchange_ADDR_t;
                                                       ...
                                                       _Bool __CS_atomic_compare_and_exchange(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_compare_and_exchange_obj, __CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_compare_and_exchange_expected, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_compare_and_exchange_desired)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[4] __CS_atomic_fetch_add(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_fetch_add_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_fetch_add_v)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[4] __CS_atomic_fetch_sub(__CPROVER_bitvector[4] *__csLOCALPARAM___CS_atomic_fetch_sub_obj, __CPROVER_bitvector[4] __csLOCALPARAM___CS_atomic_fetch_sub_v)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[4] __cs_function_Init_inlined = 1;
                                                       __CPROVER_bitvector[4] __cs_function_Destroy_inlined = 1;
                                                       __CPROVER_bitvector[4] __cs_function_Pop_inlined = 1;
                                                       __CPROVER_bitvector[4] __cs_function_Push_inlined = 1;
                                                       void *thread_0(void *__csLOCALPARAM_thread_arg)
                                                       {
                                                       static size_t __csLOCAL_thread_i;
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_idx;
IF(1,0,tthread_0_1)                                    __csLOCAL_thread_idx = (__CPROVER_bitvector[4]) ((size_t) __csLOCALPARAM_thread_arg);
                                                       __csLOCAL_thread_i = 0;
                                                       	{
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_elem;
                                                       		{
                                                       static __CPROVER_bitvector[4] __retval__Pop_1;
                                                       			{
...
tthread_0_1: IF(1,1,tthread_0_2)                       __csLOCAL_Pop___while_cond_0 = __CS_atomic_load(&stack.count) > 1;
                                                       ...
                                                       goto __exit_loop_3;
                                                       				...
                                                       				;
                                                       				{
                                                       static __CPROVER_bitvector[4] __csLOCAL_Pop_head1;
tthread_0_2: IF(1,2,tthread_0_3)                       __csLOCAL_Pop_head1 = __CS_atomic_load(&stack.head);
                                                       static __CPROVER_bitvector[4] __csLOCAL_Pop_next1;
tthread_0_3: IF(1,3,tthread_0_4)                       __csLOCAL_Pop_next1 = __CS_atomic_exchange_ADDR((stack.array + (2 * __csLOCAL_Pop_head1)) + 1, -1);
                                                       if (__csLOCAL_Pop_next1 >= 0)
                                                       					{
                                                       static __CPROVER_bitvector[4] __csLOCAL_Pop_head2;
...
tthread_0_59: IF(1,59,tthread_0_60)                    assert(__CS_atomic_READ(stack.array + (2 * __csLOCAL_thread_elem)) == __csLOCAL_thread_idx);
                                                       		{
                                                       static __CPROVER_bitvector[4] __csLOCALPARAM_Push_index;
                                                       __csLOCALPARAM_Push_index = __csLOCAL_thread_elem;
                                                       static __CPROVER_bitvector[4] __csLOCAL_Push_head1;
tthread_0_60: IF(1,60,tthread_0_61)                    __csLOCAL_Push_head1 = __CS_atomic_load(&stack.head);
                                                       ;
                                                       static __CPROVER_bitvector[4] __csLOCAL_Push___cs_dowhile_onetime_1;
...
tthread_0_139:                                         STOP_NONVOID(139);
                                                       ...
                                                       static size_t __csLOCAL_thread_i;
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_idx;
IF(2,0,tthread_1_1)                                    __csLOCAL_thread_idx = (__CPROVER_bitvector[4]) ((size_t) __csLOCALPARAM_thread_arg);
                                                       __csLOCAL_thread_i = 0;
                                                       	{
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_elem;
                                                       		{
...
tthread_1_139:                                         STOP_NONVOID(139);
                                                       ...
                                                       static size_t __csLOCAL_thread_i;
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_idx;
IF(3,0,tthread_2_1)                                    __csLOCAL_thread_idx = (__CPROVER_bitvector[4]) ((size_t) __csLOCALPARAM_thread_arg);
                                                       __csLOCAL_thread_i = 0;
                                                       	{
                                                       static __CPROVER_bitvector[4] __csLOCAL_thread_elem;
                                                       		{
...
tthread_2_139:                                         STOP_NONVOID(139);
                                                       ...
                                                       __CPROVER_bitvector[4] main_thread(void)
                                                       {
IF(0,0,tmain_1)                                        static __CPROVER_bitvector[4] __csLOCAL_main_i;
                                                       	{
                                                       static __CPROVER_bitvector[4] __csLOCALPARAM_Init_pushCount;
                                                       __csLOCALPARAM_Init_pushCount = 3;
                                                       static __CPROVER_bitvector[4] __csLOCAL_Init_i;
