...
# 1 "<command-line>" 2
# 1 "<stdin>"
# 1 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
...
# 2 "./preprocessor/ccpp-0.1/fake_include/stdio.h" 2
# 2 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/stdlib.h" 1
# 3 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/pthread.h" 1
# 4 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/unistd.h" 1
# 5 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/assert.h" 1
# 6 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c" 2
# 23 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c"
pthread_t threads[3];



unsigned int stack;
# 41 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c"
...
# 81 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/SafeStack_seqcst_forCSEQ_split_mem_ver6.c"
...
int main(void)
{
    ...
    Init(3);
        ...
        pthread_create(&threads[0], 0, thread, 0);
        pthread_create(&threads[1], 0, thread, 1);
        pthread_create(&threads[2], 0, thread, 2);
