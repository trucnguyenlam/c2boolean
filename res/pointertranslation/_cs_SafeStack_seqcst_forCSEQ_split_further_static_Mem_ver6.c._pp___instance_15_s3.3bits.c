...
/* here */
                                                       ...
                                                       __cs_t threads[3];
                                                       __CPROVER_bitvector[3] MEMORY_VALUE[8];
                                                       #define array_Value 0
                                                       #define array_Next 3
                                                       #define head 6
                                                       #define count 7
                                                       void __CS_atomic_store(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_store_obj, __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_store_v)
                                                       {
                                                         MEMORY_VALUE[__csLOCALPARAM___CS_atomic_store_obj] = __csLOCALPARAM___CS_atomic_store_v;
                                                       }

                                                       __CPROVER_bitvector[3] __CS_atomic_load(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_load_obj)
                                                       {
                                                         return MEMORY_VALUE[__csLOCALPARAM___CS_atomic_load_obj];
                                                       }

                                                       __CPROVER_bitvector[3] __CS_atomic_exchange(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_exchange_obj, __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_exchange_v)
                                                       {
                                                       ...
                                                       _Bool __CS_atomic_compare_and_exchange(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_compare_and_exchange_obj, __CPROVER_bitvector[3] *__csLOCALPARAM___CS_atomic_compare_and_exchange_expected, __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_compare_and_exchange_desired)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[3] __CS_atomic_fetch_add(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_fetch_add_obj, __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_fetch_add_v)
                                                       {
                                                       ...
                                                       __CPROVER_bitvector[3] __CS_atomic_fetch_sub(unsigned __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_fetch_sub_obj, __CPROVER_bitvector[3] __csLOCALPARAM___CS_atomic_fetch_sub_v)
                                                       {
