...
/* here */
                                                       ...
                                                       int __CS_atomic_READ(unsigned int address)
                                                       {
                                                         static unsigned __CPROVER_bitvector[4] pos;
                                                         pos = nondet_uint();
                                                         __CPROVER_assume(pos < 6);
                                                       ...
                                                       {
                                                         static unsigned __CPROVER_bitvector[4] __csLOCAL___CS_atomic_WRITE_pos;
                                                         __csLOCAL___CS_atomic_WRITE_pos = nondet_uint();
                                                         __CPROVER_assume(__csLOCAL___CS_atomic_WRITE_pos < 6);
                                                         __CPROVER_assume(TRACK_ADDRESS[__csLOCAL___CS_atomic_WRITE_pos] == __csLOCALPARAM___CS_atomic_WRITE_address);
                                                         TRACK_VALUE[__csLOCAL___CS_atomic_WRITE_pos] = __csLOCALPARAM___CS_atomic_WRITE_value;
                                                       }
...
typedef
                                                       ...
                                                       {
                                                         static unsigned int __csLOCAL___CS_atomic_exchange_ADDR_pos;
