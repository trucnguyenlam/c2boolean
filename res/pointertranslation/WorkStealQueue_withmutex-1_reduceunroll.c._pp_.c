...
# 1 "<command-line>" 2
# 1 "<stdin>"
# 1 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
...
# 2 "./preprocessor/ccpp-0.1/fake_include/stdio.h" 2
# 7 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/pthread.h" 1
# 8 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/stdlib.h" 1
# 9 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/unistd.h" 1
# 10 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/pthread.h" 1
# 11 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/assert.h" 1
# 12 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c" 2
...
{
# 65 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c"
    pthread_mutex_t cs;
...
# 140 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c"
...
{
    long t = readV(&q->tail);
# 295 "/home/trucnguyenlam/Development/cseq/regression/pointertranslation/WorkStealQueue_withmutex-1_reduceunroll.c"
...
int main(void)
{
    ...
    for (i = 0; i < 4/2; i++)
    {
        Init_ObjType(&items[2*i]);
        Init_ObjType(&items[2*i+1]);
    }
