/*  Generated 0.0.0.0.0.0 (-t3 -r4 -u3 -bcbmc) 2015-12-09 12:23:50  */
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
IF(0,0,tmain_1)                                        static int __csLOCAL_main_i;
                                                       ...
                                                       static unsigned int __csLOCAL_Init_s1;
                                                       __csLOCAL_Init_s1 = 3 * (sizeof(int));
                                                       stack.array_Value = __cs_safe_malloc(__csLOCAL_Init_s1 + __csLOCAL_Init_s1);
