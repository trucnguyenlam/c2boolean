...
void init_MEM(void)
{
		...
		__CPROVER_assume((TRACK_ADDRESS[17] <= 10000) & (TRACK_ADDRESS[17] > TRACK_ADDRESS[16]));
		TRACK_ADDRESS[18] = TRACK_ADDRESS_tmp[1];
		__CPROVER_assume((TRACK_ADDRESS[18] <= 10000) & (TRACK_ADDRESS[18] > TRACK_ADDRESS[17]));
		TRACK_ADDRESS[19] = TRACK_ADDRESS_tmp[2];
		__CPROVER_assume((TRACK_ADDRESS[19] <= 10000) & (TRACK_ADDRESS[19] > TRACK_ADDRESS[18]));
		TRACK_ADDRESS[20] = TRACK_ADDRESS_tmp[3];
		__CPROVER_assume((TRACK_ADDRESS[20] <= 10000) & (TRACK_ADDRESS[20] > TRACK_ADDRESS[19]));
		TRACK_ADDRESS[21] = TRACK_ADDRESS_tmp[4];
		__CPROVER_assume((TRACK_ADDRESS[21] <= 10000) & (TRACK_ADDRESS[21] > TRACK_ADDRESS[20]));
		TRACK_ADDRESS[22] = TRACK_ADDRESS_tmp[5];
		__CPROVER_assume((TRACK_ADDRESS[22] <= 10000) & (TRACK_ADDRESS[22] > TRACK_ADDRESS[21]));
		TRACK_ADDRESS[23] = TRACK_ADDRESS_tmp[6];
		__CPROVER_assume((TRACK_ADDRESS[23] <= 10000) & (TRACK_ADDRESS[23] > TRACK_ADDRESS[22]));
		TRACK_ADDRESS[24] = TRACK_ADDRESS_tmp[7];
		__CPROVER_assume((TRACK_ADDRESS[24] <= 10000) & (TRACK_ADDRESS[24] > TRACK_ADDRESS[23]));
		TRACK_ADDRESS[25] = TRACK_ADDRESS_tmp[8];
		__CPROVER_assume((TRACK_ADDRESS[25] <= 10000) & (TRACK_ADDRESS[25] > TRACK_ADDRESS[24]));
		TRACK_ADDRESS[26] = TRACK_ADDRESS_tmp[9];
		__CPROVER_assume((TRACK_ADDRESS[26] <= 10000) & (TRACK_ADDRESS[26] > TRACK_ADDRESS[25]));
		TRACK_ADDRESS[27] = TRACK_ADDRESS_tmp[10];
		__CPROVER_assume((TRACK_ADDRESS[27] <= 10000) & (TRACK_ADDRESS[27] > TRACK_ADDRESS[26]));
		TRACK_ADDRESS[28] = TRACK_ADDRESS_tmp[11];
		__CPROVER_assume((TRACK_ADDRESS[28] <= 10000) & (TRACK_ADDRESS[28] > TRACK_ADDRESS[27]));
		TRACK_ADDRESS[29] = TRACK_ADDRESS_tmp[12];
		__CPROVER_assume((TRACK_ADDRESS[29] <= 10000) & (TRACK_ADDRESS[29] > TRACK_ADDRESS[28]));
		TRACK_ADDRESS[30] = 10001;
}
